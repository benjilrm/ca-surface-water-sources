...
# Export
```{r}
st_write(connections_sf, "Data/Outputs/Shapefiles for dashboard/20260505_connections.shp", delete_dsn = T)

st_write(systems_sf, "Data/Outputs/Shapefiles for dashboard/20260505_systems.shp", delete_dsn = T)

st_write(jittered_sources, "Data/Outputs/Shapefiles for dashboard/20260505_sources.shp", delete_dsn = T)
```
